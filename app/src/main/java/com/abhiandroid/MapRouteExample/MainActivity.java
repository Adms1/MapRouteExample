...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getLocationFromAddress(MainActivity.this, source, desti);
        drawPolylines();
...
//        }
    ...
    public LatLng getLocationFromAddress(Context context, String strSourceAddress, String strDestiAddress) {
        ...
        try {
            ...
            address = coder.getFromLocationName(strSourceAddress, 5);
            address1 = coder.getFromLocationName(strDestiAddress, 5);
            ...
            dest = new LatLng(location1.getLatitude(), location1.getLongitude());
            Log.d("latlng", "" + p1);
